...
nv-vimeo aims to be a very easy and Ruby wrapper around the Vimeo API.

With nv-vimeo, you can upload a video file to the Vimeo website and set its basic properties in a few lines of code.
